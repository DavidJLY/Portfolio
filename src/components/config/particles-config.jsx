const particlesConfig = {
  particles: {
    ...
    opacity: {
      value: 0.3, // Augmentation de l'opacité pour plus de visibilité
      random: false,
      anim: {
        enable: false,
        speed: 1,
    ...
    line_linked: {
      enable: true,
      distance: 200,
      color: "#ffffff", // Lignes blanches pour un bon contraste
  ...
  retina_detect: true,
  background: {
    color: "#000000", // Fond noir pour maximiser le contraste
  },
};
